            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  // Optional: If you want to remove any padding inside the button
                  backgroundColor: Colors.transparent,
                  // Optional: To make the background transparent (if needed)
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.green,
                    // Background color of the button (green in this case)
                    borderRadius: BorderRadius.circular(
                ...
                child: Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                      children: [
                        const TextSpan(
                          text: 'Катталган аккаунтуңуз барбы? ',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 12.0,
                            fontFamily: 'Roboto',
