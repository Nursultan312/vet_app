...
class BizJonundo extends StatefulWidget {
  @override
  State<BizJonundo> createState() => _BizJonundoState();
}

class _BizJonundoState extends State<BizJonundo> {
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Image.asset(
              'assets/images/bizjonundo.png', // Path to the image you want to show
